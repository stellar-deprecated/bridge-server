...
func migrations_compliance02_auth_dataSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations_compliance/02_auth_data.sql", size: 234, mode: os.FileMode(420), modTime: time.Unix(1528369167, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
