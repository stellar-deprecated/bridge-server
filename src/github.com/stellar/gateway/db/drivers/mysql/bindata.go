...
func migrations01_initSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/01_init.sql", size: 760, mode: os.FileMode(420), modTime: time.Unix(1453985025, 0)}
