...
type RepositoryInterface interface {
	...
	GetAuthData(id string) (*entities.AuthData, error)
...
// GetAuthData returns received auth data by id
func (r Repository) GetAuthData(id string) (*entities.AuthData, error) {
	var found entities.AuthData

	err := r.repo.GetRaw(
		&found,
		"SELECT * FROM AuthData WHERE id = ?",
		id,
	)
