...
var AssetFS AssetFSInterface = &bindataFS{AssetFileSystem: &assetfs.AssetFileSystem{}, Path: "src/github.com/stellar/gateway/bridge/handlers/admin/"}
